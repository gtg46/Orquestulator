...
async def get_execution(execution_id: str, config: StackStormConfig):
    """
    ...
    try:
        ...
        if config.api_key:
            ...
            if len(config.api_key) <= 32 and all(c in '0123456789abcdef' for c in config.api_key):
        ...
        # Handle specific HTTP error codes
            ...
            try:
                ...
                error_detail = error_data.get('faultstring', error_data.get('detail', response.text))
            except:
